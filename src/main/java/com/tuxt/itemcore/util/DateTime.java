...
public class DateTime {
     ...
     * */
    public static java.sql.Timestamp getDateByString(String strDate)throws Exception {
    ...
    public static java.sql.Timestamp formatDateTimeStr(String strDate)throws Exception {
        if (strDate.trim().equals("")) {
            return getCurrentDate();
        }
        try {
